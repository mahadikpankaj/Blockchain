...
class StateList {
    ...
    async addState(state) {
        ...
        console.log("Composite Key: " + this.name + " - " + key);
    ...
    async getStatesList(queryString) {
        ...
        //let iterator = await this.ctx.stub.getQueryResult(JSON.stringify(queryString));
...
//                allResults.push(State.deserialize(res.value.value, this.supportedClasses));
